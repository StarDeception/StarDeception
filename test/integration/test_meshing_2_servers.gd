...
func test_start_server1():
	...
	Server1.mqtt_client_sdo = Mqttgut.instantiate()
...
func test_server1_receive_serverslist():
	...
	assert_eq(Server1.mqtt_client_sdo.subscribed, {"sdo/playerslist": true, "sdo/serverschanges": true})
...
func test_start_server2():
	...
	var Mqttgut = preload("res://test/servermeshing/sdoInterface.tscn")
	Server2.mqtt_client_sdo = Mqttgut.instantiate()
...
func test_server2_receive_serverslist():
	...
	assert_eq(Server2.mqtt_client_sdo.subscribed, {"sdo/serverslist": true, "sdo/playerslist": true})
...
func test_server2_receive_serverslist_aftersplit():
	...
	assert_eq(Server2.mqtt_client_sdo.subscribed, {"sdo/playerslist": true, "sdo/serverschanges": true})



func test_server2_receive_playerslist_aftersplit():
	Server2.mqtt_client_sdo.messages["sdo/playerslist"] = [JSON.stringify([
		{
			"name": Player1.name,
			"client_uuid": Player1.uuid,
			"server_id": 1,
	...
	Server2._on_mqtt_sdo_received_message("sdo/playerslist", Server2.mqtt_client_sdo.messages["sdo/playerslist"].get(0))
	await wait_frames(5)

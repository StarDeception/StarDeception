...
func _unhandled_input(event: InputEvent) -> void:
	...
	if GlobalChat.globalchat_is_visible: return
...
func _physics_process(delta: float) -> void:
	...
	if dir_vect and !GlobalChat.globalchat_is_visible:
	...
	if is_on_floor():
		if input_direction and !GlobalChat.globalchat_is_visible:
	...
	if is_on_floor() and jump and !GlobalChat.globalchat_is_visible:
